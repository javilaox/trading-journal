...
const api = {
  ...
  uploadTradeImage: (localPath) => ipcRenderer.invoke('upload-trade-image', localPath),
  getTradeImageUrl: (ref) => ipcRenderer.invoke('get-trade-image-url', ref),
  cacheTradeImageLocally: (ref) => ipcRenderer.invoke('cache-trade-image-locally', ref),
  ...
  getWithdrawalsLocal: () => ipcRenderer.invoke('get-withdrawals-local'),
  addWithdrawalLocal: (withdrawal) => ipcRenderer.invoke('add-withdrawal-local', withdrawal),
  updateWithdrawalLocal: (withdrawal) => ipcRenderer.invoke('update-withdrawal-local', withdrawal),
  deleteWithdrawalLocal: (idOrClientUuid) => ipcRenderer.invoke('delete-withdrawal-local', idOrClientUuid),
  getExpensesLocal: () => ipcRenderer.invoke('get-expenses-local'),
  addExpenseLocal: (expense) => ipcRenderer.invoke('add-expense-local', expense),
  updateExpenseLocal: (expense) => ipcRenderer.invoke('update-expense-local', expense),
  deleteExpenseLocal: (idOrClientUuid) => ipcRenderer.invoke('delete-expense-local', idOrClientUuid),
  getExpensePropsLocal: () => ipcRenderer.invoke('get-expense-props-local'),
  addExpensePropLocal: (prop) => ipcRenderer.invoke('add-expense-prop-local', prop),
  updateExpensePropLocal: (prop) => ipcRenderer.invoke('update-expense-prop-local', prop),
  deleteExpensePropLocal: (clientUuidOrId) => ipcRenderer.invoke('delete-expense-prop-local', clientUuidOrId),
  getExpenseCategoriesLocal: () => ipcRenderer.invoke('get-expense-categories-local'),
  addExpenseCategoryLocal: (payload) => ipcRenderer.invoke('add-expense-category-local', payload),
  updateExpenseCategoryLocal: (payload) => ipcRenderer.invoke('update-expense-category-local', payload),
  deleteExpenseCategoryLocal: (clientUuidOrId) => ipcRenderer.invoke('delete-expense-category-local', clientUuidOrId),
  ...
  addBacktestTradesBulk: (trades) => ipcRenderer.invoke('add-backtest-trades-bulk', trades),
  downloadBacktestTemplate: () => ipcRenderer.invoke('download-backtest-template'),
  readBacktestImportFile: (options) => ipcRenderer.invoke('read-backtest-import-file', options),
...
contextBridge.exposeInMainWorld('api', {
  ...
  getWithdrawalsLocal: api.getWithdrawalsLocal,
  addWithdrawalLocal: api.addWithdrawalLocal,
  updateWithdrawalLocal: api.updateWithdrawalLocal,
  deleteWithdrawalLocal: api.deleteWithdrawalLocal,
  getExpensesLocal: api.getExpensesLocal,
  addExpenseLocal: api.addExpenseLocal,
  updateExpenseLocal: api.updateExpenseLocal,
  deleteExpenseLocal: api.deleteExpenseLocal,
  getExpensePropsLocal: api.getExpensePropsLocal,
  addExpensePropLocal: api.addExpensePropLocal,
  updateExpensePropLocal: api.updateExpensePropLocal,
  deleteExpensePropLocal: api.deleteExpensePropLocal,
  ...
  uploadTradeImage: api.uploadTradeImage,
  getTradeImageUrl: api.getTradeImageUrl,
  cacheTradeImageLocally: api.cacheTradeImageLocally,
  ...
  addBacktestTradesBulk: api.addBacktestTradesBulk,
  downloadBacktestTemplate: api.downloadBacktestTemplate,
  readBacktestImportFile: api.readBacktestImportFile,
  ...
  getExpenseCategoriesLocal: api.getExpenseCategoriesLocal,
  addExpenseCategoryLocal: api.addExpenseCategoryLocal,
  updateExpenseCategoryLocal: api.updateExpenseCategoryLocal,
  deleteExpenseCategoryLocal: api.deleteExpenseCategoryLocal,
