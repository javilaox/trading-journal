...
(function () {
  ...
  function byDay() {
    var map = {};
    MONTH_TRADES.forEach(function (t) {
  ...
  function renderCalendar() {
    ...
    var monthPnl = 0;
    MONTH_TRADES.forEach(function (t) { monthPnl += Number(t.pnl) || 0; });
    $('calMonthOps').textContent = MONTH_TRADES.length;
  ...
  function renderDay() {
    ...
    var list = MONTH_TRADES.filter(function (t) { return String(t.date || '').slice(0, 10) === SELECTED_DAY; });
