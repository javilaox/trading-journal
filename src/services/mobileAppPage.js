...
(function () {
  ...
  function matchesFilters(t) {
    // Una operación tomada en varias cuentas pertenece a todas: sale al filtrar por cualquiera.
    if (FILTERS.account) {
      var cuentas = Array.isArray(t.account_executions) && t.account_executions.length
        ? t.account_executions.map(function (e) { return String(e && e.account || ''); })
        : [String(t.account || '')];
      if (cuentas.indexOf(FILTERS.account) === -1) return false;
    }
